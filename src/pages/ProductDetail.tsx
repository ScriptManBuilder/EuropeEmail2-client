          ...
          <ImageSection>
            {isVideoMode && product.video ? (
              ...
              >
                ...
                <track
                  kind="subtitles"
                  src={`/subtitles/courses/${product.id}-en.vtt`}
                  srcLang="en"
                  label="English"
                  default
                />
                <track
                  kind="subtitles"
                  src={`/subtitles/courses/${product.id}-fr.vtt`}
                  srcLang="fr"
                  label="Français"
                />
                <track
                  kind="subtitles"
                  src={`/subtitles/courses/${product.id}-es.vtt`}
                  srcLang="es"
                  label="Español"
                />
                <track
                  kind="subtitles"
                  src={`/subtitles/courses/${product.id}-nl.vtt`}
                  srcLang="nl"
                  label="Nederlands"
                />
