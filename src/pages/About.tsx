...
const About: React.FC = () => {
  ...
  return (
    <AboutWrapper>
        ...
        <Container>
          <ContentContainer>
            <CompanyName ref={setElementRef(0)}>
              {splitTextToLetters('MAILLEARN')}
            </CompanyName>
            
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower email marketers worldwide with professional email marketing education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform marketing concepts into practical email marketing skills.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted email marketing courses cover automation principles, list building, campaign optimization, email design techniques, conversion strategies, and analytics. Each course is designed with hands-on projects, real-world applications, and professional techniques to help you master email marketing and advance your career in the digital marketing industry.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our Email Marketing Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive email marketing learning programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
        ...
        <Container>
          <StatsContainer>
            <StatsTitle ref={setElementRef(20)}>
              {splitTextToWords('Transforming Careers Through Email Marketing Education')}
            </StatsTitle>
            ...
            <StatsGrid>
              <StatCard ref={setElementRef(21)}>
                ...
                <StatDescription>From animation beginners to professional artists across 100+ countries</StatDescription>
              </StatCard>
              ...
              <StatCard ref={setElementRef(23)}>
                ...
                <StatDescription>Leading creative agencies hiring our animation artists</StatDescription>
              </StatCard>
              ...
              <StatCard ref={setElementRef(25)}>
                ...
                <StatLabel>Animation Specializations</StatLabel>
              ...
              <StatCard ref={setElementRef(26)}>
                ...
                <StatDescription>Consistently rated as the top animation learning platform</StatDescription>
              </StatCard>
            </StatsGrid>
          </StatsContainer>
        </Container>
      ...
      {/* Animation Learning Timeline Section */}
      {/* <TimelineSection>
        <Container>
          <TimelineContainer>
            <SectionTitle ref={setElementRef(12)} style={{ color: '#2d3748' }}>
              {splitTextToLetters('OUR ANIMATION JOURNEY')}
            </SectionTitle>
            ...
            <Timeline>
              <TimelineItem ref={setElementRef(13)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    MailLearn was founded with a vision to democratize Email Marketing education 
                    and make animation accessible to everyone, from complete beginners to advanced animators.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem ref={setElementRef(14)}>
                ...
                <TimelineContent>
                  <TimelineTitle>🎨 First Animation Courses</TimelineTitle>
                  <TimelineDescription>
                    Launched our first comprehensive animation courses, featuring hands-on projects 
              ...
              <TimelineItem ref={setElementRef(15)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    Established partnerships with leading animation studios and motion design artists 
              ...
              <TimelineItem ref={setElementRef(16)}>
                ...
                <TimelineContent>
                  <TimelineTitle>🚀 Advanced Animation Expansion</TimelineTitle>
                  <TimelineDescription>
                    Expanded our course offerings to include advanced animation topics: 
                    character animation, motion graphics, 3D modeling, and visual effects.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem ref={setElementRef(17)}>
                ...
                <TimelineContent>
                  <TimelineTitle>🌐 Professional Animation Era</TimelineTitle>
                  <TimelineDescription>
                    Pioneered comprehensive professional animation courses, 
                    helping students master both basic and advanced email marketing techniques.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem ref={setElementRef(18)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    ...
                    email marketing education platform by major marketing industry publications.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem ref={setElementRef(19)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    Continuing to lead email marketing education with emerging techniques, modern email marketing practices, 
                    and innovative learning methodologies for the next generation of animators.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
            </Timeline>
      ...
      {/* Email Marketing Education Team Section */}
      <LeadershipSection>
        <Container>
          <LeadershipContainer>
            ...
            <LeadershipGrid>
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                <LeaderImage>
                  <img src="/images/mail_1.jpg" alt="Education Team" />
                  <LeaderOverlay>
                ...
                <LeaderInfo>
                  ...
                  <LeaderTitle>Email Marketing Experts & Educators</LeaderTitle>
                  <LeaderDescription>
                    Passionate about email marketing and dedicated to making email marketing education accessible to everyone. 
                    Creates comprehensive video courses to help others learn and master the art of email marketing automation.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in Email Marketing Education</ValueTitle>
                <ValueDescription>
                  We maintain the highest standards in email marketing education, constantly updating 
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  Email marketing should be accessible to everyone. We create a supportive environment 
                  where marketers from all backgrounds can master email marketing fundamentals.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(30)}>
                <ValueIcon>⚡</ValueIcon>
                <ValueTitle>Modern Email Marketing Techniques</ValueTitle>
                <ValueDescription>
                  We stay current with the latest email marketing tools and automation platforms, 
                  bringing modern marketing practices directly to our students.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(32)}>
                ...
                <ValueDescription>
                  Animation is an evolving field. We foster continuous learning 
              ...
              <ValueCard ref={setElementRef(33)}>
                ...
                <ValueDescription>
                  We focus on practical email marketing skills that you can apply immediately 
                  in real campaigns, from list building to automation workflows and conversion optimization.
                </ValueDescription>
              </ValueCard>
            </ValuesGrid>
            ...
            <MissionStatement ref={setElementRef(34)}>
              ...
              <MissionStatementText>
                To empower the next generation of email marketing professionals with world-class education, 
                practical skills, and real-world campaigns that drive marketing career success. 
                We believe that by making email marketing education accessible and excellent, we can help 
                students create amazing email campaigns while creating opportunities for everyone 
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalHeader>
            <ModalImage>
              <img src="/images/mail_2.jpg" alt="Education Team" />
            </ModalImage>
          
            <ModalSubtitle>Email Marketing Education Experts</ModalSubtitle>
          </ModalHeader>

          <ModalDescription>
            Our team of professional email marketing experts is dedicated to 
            transforming marketing careers through comprehensive email marketing education.
            <br /><br />
            We believe email marketing should be accessible to everyone, from complete beginners to advanced marketers looking to 
            refine their skills. That's why we created comprehensive video courses that break down complex email marketing concepts 
            into understandable, practical lessons.
            <br /><br />
            Our mission is simple: to help others discover the amazing world of email marketing and empower them 
            with the knowledge and skills needed to create high-converting email campaigns and advance their marketing careers. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately.
            <br /><br />
            Whether you're just starting your email marketing journey or looking to master advanced automation techniques, 
            our expert team is here to guide you every step of the way. Let's explore the incredible possibilities of email marketing together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
