...
const ShippingPolicy: React.FC = () => {
  ...
  return (
    <Container>
      <Title>Digital Service Delivery Policy</Title>
      ...
      <Section>
        <Paragraph>
          {COMPANY_INFO.name} delivers email management services digitally through our secure online platform. 
          This policy explains how your services are delivered and accessed after purchase.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          <strong>Our email management services are 100% digital products.</strong> There are no physical items to ship. All service materials, 
          including tools, templates, and resources, are delivered instantly through your online account.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased email management services. No waiting, no shipping delays - 
          start using your services within minutes of your purchase.
        </Paragraph>
        <Paragraph>
          <strong>Delivery Method:</strong> Secure online platform access<br/>
          <strong>Delivery Time:</strong> Instant upon payment confirmation<br/>
          <strong>Access Duration:</strong> Lifetime access to all service materials
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Login credentials for your service account<br/>
          • Direct links to your purchased services<br/>
      ...
      <Section>
        ...
        <Paragraph>
          Our digital email management services are available worldwide with internet access. There are no geographical restrictions 
      ...
      <Section>
        <SectionTitle>5. Service Platform Access</SectionTitle>
        <Paragraph>
          Your services are hosted on our secure management system, accessible 24/7 from any device:
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          Many service materials are available for download, allowing offline access:
        </Paragraph>
        <Paragraph>
          • PDF guides and templates<br/>
          • Configuration files and resources<br/>
          • Template files and presets<br/>
          • Service completion certificates<br/>
          • Note: Service management requires internet connection
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          Minimum requirements for optimal service experience:
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          Your service access is protected by secure login credentials. Keep your account information safe:
        </Paragraph>
        <Paragraph>
