    ...
    <CheckoutWrapper>
      <Container>
        <CheckoutHeader>
          ...
          <CheckoutSubtitle>Complete your enrollment for premium email management services</CheckoutSubtitle>
        </CheckoutHeader>
          ...
          <CheckoutForm onSubmit={handleSubmit}>
            ...
            {hasPendingMembership && (
              <MembershipSection>
                ...
                <MembershipDetails>
                  ...
                  <MembershipBenefits>
                    <MembershipBenefit>20% discount on all services</MembershipBenefit>
                    ...
                    <MembershipBenefit>Early access to new services</MembershipBenefit>
                    <MembershipBenefit>Monthly live Q&A sessions</MembershipBenefit>
                    <MembershipBenefit>Advanced service features</MembershipBenefit>
                  </MembershipBenefits>
            ...
            <CheckoutNotices>
              <NoticeSection>
                ...
                <NoticeText>
                  Instant access to all service features upon successful payment. Access details will be sent to your email.
                </NoticeText>
              </NoticeSection>
            ...
            <BillingDescriptorSection>
              ...
              <BillingDescriptorText>
                Your credit card will be billed with the following descriptor: <strong>EMAIL.SERVICES</strong>. This is how the charge will appear on the cardholder's billing statement.
              </BillingDescriptorText>
            </BillingDescriptorSection>
            ...
            <TermsCheckbox>
              <CheckboxContainer>
                ...
                <TermsText>
                  ...
                  I agree to pay the total amount provided on the checkout page. Upon successful payment, I will receive instant access to all service features. 
                  ...
                  Your credit card will be billed with the following descriptor: EMAIL.SERVICES. This is how the 
                  charge will appear on the cardholder's billing statement. Service access will be provided immediately after successful payment.
                </TermsText>
              </CheckboxContainer>
            </TermsCheckbox>
          ...
          <OrderSummary>
            ...
            <OrderFeatures>
              <FeatureItem>
                ...
                <span>Instant service access upon payment</span>
              </FeatureItem>
              <FeatureItem>
                <FeatureIcon>🔒</FeatureIcon>
              ...
              <FeatureItem>
                ...
                <span>Lifetime access to service features</span>
              </FeatureItem>
              <FeatureItem>
                <FeatureIcon>📱</FeatureIcon>
              ...
              <BillingInfo>
                ...
                <div>
                  ...
                  Your credit card will be billed as <strong>EMAIL.SERVICES</strong>. This is how the charge will appear on your billing statement.
                </div>
              </BillingInfo>
            </OrderFeatures>
          </OrderSummary>
