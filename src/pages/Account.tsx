...
const Account: React.FC = () => {
  ...
  const renderCoursesSection = () => {
    ...
    if (!isTestAccount) {
      return (
        <div>
          <SectionTitle>MY Mail COURSES</SectionTitle>
          
          <InfoCard>
            <EmptyOrdersText>
              � Your purchased Mail courses will appear here after successful payment.
            </EmptyOrdersText>
            <EmptyOrdersText style={{ fontSize: '1rem', marginTop: '1rem', opacity: 0.8 }}>
              Once you purchase any Mail course, you'll have lifetime access to all course materials, 
    ...
    return (
      <div>
        ...
        <div style={{ 
          ...
          }}>Continue your Mail mastery journey</p>
          <div style={{ 
            display: 'flex', 
